...
class _PortfolioPageState extends State<PortfolioPage> {
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    _textField(controller: _linkedIn,
                        hintText: "Linked In",
                        validator: (v) => null),
                    SizedBox(height: size.height * .03,),
                    _textField(controller: _gitHub,
                        hintText: "GitHub",
                        validator: (v) => null),
                  ],
                ),
                    ...
                    MaterialButton(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Form(
                                              ...
                                              child: Column(
                                                children: [
                                                  _textField(controller: _title,
                                                      hintText: "Title",
                                                      validator: (v) => null),
                                                  SizedBox(height: size.height *
                                                      .015),
                                                  _textField(controller: _links,
                                                      hintText: "Links",
                                                      validator: (v) => null),
                                                ],
                                              ),
                      ...
                      child: Row(
                        children: [
                          ...
                          Text("Add Link", style: GoogleFonts.lato(
                              color: Colors.blue,
                              fontSize: 13,
                              fontWeight: FontWeight.w500),),
                        ],
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text("Media", style: GoogleFonts.lato(color: Colors.black,
                        fontSize: 13,
                        fontWeight: FontWeight.w500),),
                  ],
                ),
                      ...
                      () async{
                          ...
                          if(picker != null){
                            ...
                            final result  =  await Navigator.push(context,
                                PageTransition(type: PageTransitionType.fade , child: AddMedia(file: sourcePath)));
  ...
  Widget _mediaData(  BuildContext context,MediaItems item , VoidCallback onEdit , VoidCallback onDelete){
    var size = MediaQuery.of(context).size;
    return Padding(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              ClipRRect(
                borderRadius: BorderRadius.circular(11),
                child: Image.file(item.file,width: size.width * .25, height: size.height * .1,fit: BoxFit.cover,),
              ),
              SizedBox(width: size.width * .03,),
              Expanded(
                child: Text(item.title.isNotEmpty ? item.title : "Untitled" ,
